...
public class LoveAdapter extends BaseAdapter {
    ...
    private List<LoveFile> list;
    public LoveAdapter(Context context, List<LoveFile> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.activity_love_item, null);//实例化一个布局文件
            viewHolder = new ViewHolder();
            viewHolder.iv_icon = (ImageView) convertView.findViewById(R.id.loveIcon);
            viewHolder.tv_school = (TextView) convertView.findViewById(R.id.loveSchool);
            viewHolder.tv_name = (TextView) convertView.findViewById(R.id.loveName);
            viewHolder.tv_desc = (TextView) convertView.findViewById(R.id.loveDesc);
            viewHolder.tv_tell = convertView.findViewById(R.id.loveTell);
            ...
            viewHolder.tv_school.setText(school);
