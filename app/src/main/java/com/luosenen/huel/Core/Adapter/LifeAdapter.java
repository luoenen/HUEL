...
public class LifeAdapter extends BaseAdapter {
    ...
    private List<LifeFile> list;
    public LifeAdapter(Context context, List<LifeFile> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.activity_life_item, null);//实例化一个布局文件
            viewHolder = new ViewHolder();

            viewHolder.tv_name = (TextView) convertView.findViewById(R.id.lifeName);
            viewHolder.tv_desc = (TextView) convertView.findViewById(R.id.lifeDesc);
            viewHolder.tv_tell = convertView.findViewById(R.id.lifeTell);
            ...
            viewHolder.tv_desc.setText(String.valueOf(desc));
