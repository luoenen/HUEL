...
public class ExpressAdapter extends BaseAdapter {
    ...
    private List<ExpressFile> list;
    public ExpressAdapter(Context context, List<ExpressFile> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.activity_express_item, null);//实例化一个布局文件
            viewHolder = new ViewHolder();


            viewHolder.tv_address = (TextView) convertView.findViewById(R.id.expressAddress);
            viewHolder.tv_name = (TextView) convertView.findViewById(R.id.expressName);
            viewHolder.tv_price = (TextView) convertView.findViewById(R.id.myExpressPriceAct);
            viewHolder.tv_tell = convertView.findViewById(R.id.expressTell);
