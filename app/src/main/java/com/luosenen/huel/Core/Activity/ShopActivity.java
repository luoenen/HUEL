...
import com.luosenen.huel.Core.Adapter.ShopAdapter;
...
public class ShopActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.shopBack);
        add = findViewById(R.id.toShop);
        ...
        BmobQuery<ShopFile> bmobQuery = new BmobQuery<ShopFile>();
        bmobQuery.findObjects(new FindListener<ShopFile>() {
            @Override
            public void done(List<ShopFile> list, BmobException e) {
                ...
                if (e == null) {
                    ...
                    listView.setAdapter(new ShopAdapter(ShopActivity.this, list));
                }
            }
