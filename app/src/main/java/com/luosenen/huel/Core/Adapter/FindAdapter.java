...
public class FindAdapter extends BaseAdapter {
    ...
    private List<FindFile> list;
    public FindAdapter(Context context, List<FindFile> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.activity_find_item, null);//实例化一个布局文件
            viewHolder = new ViewHolder();
            viewHolder.iv_icon = (ImageView) convertView.findViewById(R.id.FindIcon);
            viewHolder.tv_name = (TextView) convertView.findViewById(R.id.FindName);
            viewHolder.tv_desc = (TextView) convertView.findViewById(R.id.FindDesc);
            viewHolder.tv_tell = convertView.findViewById(R.id.FindTell);
