...
public class UniversityAdapter extends BaseAdapter {
    ...
    private List<UniversityFile> list;
    public UniversityAdapter(Context context, List<UniversityFile> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.activity_university_item, null);//实例化一个布局文件
            viewHolder = new ViewHolder();
            viewHolder.iv_icon = (ImageView) convertView.findViewById(R.id.universityIcon);
            viewHolder.tv_college = (TextView) convertView.findViewById(R.id.universityCollege);
            viewHolder.tv_name = (TextView) convertView.findViewById(R.id.universityName);
            viewHolder.tv_desc = (TextView) convertView.findViewById(R.id.universityDesc);
            viewHolder.tv_tell = convertView.findViewById(R.id.universityTell);
            ...
            viewHolder.tv_college.setText(college);
